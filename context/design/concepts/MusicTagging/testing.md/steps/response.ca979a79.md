...
Deno.test("MusicTaggingConcept", async (test) => {
  ...
  await test.step(
    ...
    async () => {
      ...
      const resourceId1: ID = "resource_abc";
  ...
  await test.step(
    ...
    async () => {
      ...
      const resourceId: ID = "res_duplicate";
  ...
  await test.step(
    ...
    async () => {
      ...
      const resourceId: ID = "res_addtag_errors";
      ...
      const tag = "genre_pop";
      const nonExistentRegistryId: ID = "non_existent_registry";
  ...
  await test.step(
    ...
    async () => {
      ...
      const resourceId: ID = "res_removetag_errors";
      ...
      const nonExistentRegistryId: ID = "non_existent_registry_remove";
  ...
  await test.step(
    ...
    async () => {
      ...
      const resourceId: ID = "res_delete_reregister";
      ...
      assertEquals(registryId1 !== registryId2, true, "New ID should be generated");
