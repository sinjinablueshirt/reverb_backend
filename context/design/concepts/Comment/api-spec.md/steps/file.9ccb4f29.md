...
content_id: 9ccb4f29e34c0163655acf98f06ef30f7229911346570f4ab0f550657d1808ca
---
...
export default class CommentConcept {
  ...
  async _getCommentsByResource(
  ...
  ): Promise<{ comments: CommentsCollection[] } | { error: string }> {
    ...
    // Fetch all comments associated with the resource
    const comments = await this.comments
      .find({ _id: { $in: existingResource.comments } })
      .toArray();
  ...
  ): Promise<{ comment: CommentsCollection } | null> {
