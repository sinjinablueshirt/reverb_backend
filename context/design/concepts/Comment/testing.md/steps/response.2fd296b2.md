---
timestamp: 'Sun Oct 12 2025 17:38:47 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251012_173847.d3122aa7.md]]'
content_id: 2fd296b23132f6050119ba74d8fc6c92138bb42ee1cbab6933eeedf5f4d3f4b1
---
...
Deno.test("CommentConcept: Full functionality and scenarios", async (test) => {
  ...
  await test.step("4. Scenario: Multiple comments from same user, then partial removal and invalid removal attempt", async () => {
    ...
    const commentsCountAfterFailedRemove = await concept.comments.countDocuments();
    assertEquals(
  ...
  await test.step("5. Scenario: Adding identical content comments and removing them one by one", async () => {
    ...
    const removeResult5a = await concept.removeComment({ comment: commentId5a });
    ...
    const removeResult5b = await concept.removeComment({ comment: commentId5b });
