---
timestamp: 'Thu Nov 06 2025 22:38:21 GMT-0500 (Eastern Standard Time)'
parent: '[[../20251106_223821.2491d44a.md]]'
content_id: 23c6eb27c48544a89327a49f06f64fcd40559fb3eba003a9b32b90f12cdb8ec8
---
...
// Add Tag, Remove Tag, Delete Registry (all require just a valid session)
export const MusicTaggingAuthWrapper: Sync = (
  { request, session, registry, tag },
) => ({
  when: actions(
    [Requesting.request, { path: "/MusicTagging/addTag", session, registry, tag }, { request }],
    [Requesting.request, { path: "/MusicTagging/removeTag", session, registry, tag }, { request }],
    [Requesting.request, { path: "/MusicTagging/deleteRegistry", session, registry }, { request }],
  ),
  where: (frames) => frames.query(Sessioning._getUser, { session }, {}),
  then: actions(
    [MusicTagging.addTag, { registry, tag }],
    [MusicTagging.removeTag, { registry, tag }],
    [MusicTagging.deleteRegistry, { registry }],
  ),
});
